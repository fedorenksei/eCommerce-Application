  ...
  return (
    <>
      ...
      <div className="flex justify-around items-center m-8">
        ...
        <div className="dark">
          <h3>Dark</h3>
          <div className="w-52 border-slate-800 border-2 h-10 dark:bg-dt-card-color">card-bg-color</div>
          <div className="w-52 border-slate-800 border-2 h-10 dark:bg-dt-primary-color">primary-color</div>
          <div className="w-52 border-slate-800 border-2 h-10 dark:bg-dt-secondary-color">secondary-color</div>
          <div className="w-52 border-slate-800 border-2 h-10 dark:bg-dt-accent-color">accent-color</div>
          <div className="w-52 border-slate-800 border-2 h-10 dark:bg-dt-hover-color">hover-color</div>
          <div className="w-52 border-slate-800 border-2 h-10 dark:bg-dt-disable-color">disable-color</div>
          <div className="w-52 border-slate-800 border-2 h-10 dark:bg-dt-success-color">success-color</div>
          <div className="w-52 border-slate-800 border-2 h-10 dark:bg-dt-alert-color">alert-color</div>
          <div className="w-52 border-slate-800 border-2 h-10 dark:bg-dt-danger-color">danger-color</div>
          <div className="w-52 border-slate-800 border-2 h-10 dark:bg-dt-fade-text-color">fade-text-color</div>
        </div>
      </div>
    </>
  );
